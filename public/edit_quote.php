...
if(isset($_GET['id']) && is_numeric($_GET['id']) && ($_GET['id'] > 0)) {
   ...
   if(!empty($row)) {
      ...
      <form action="edit_quote.php" method="post">
         <p><label for="">Trích dẫn <textarea name="quote" id="quote" cols="30" rows="5"><?php echo htmlspecialchars($row['quote']) ?></textarea></label></p>
         <p><label for="">Nguồn <input type="text" name="source" id="source" value="<?php echo htmlspecialchars($row['source']) ?>"></label></p>
